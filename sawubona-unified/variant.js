(function () {
  ...
  var content = {
    A: {
      ...
      storyCTAHeading:  'Find a companion for your loved one',
      ...
      waitlistSub:      'We\'re building Sawubona now. The more we know about your loved one upfront, the faster we can find the right match and get started.',
      familyFormHeading:'Find a companion for my loved one',
      familyFormSub:    'Tell us a little about your loved one so we can find the right match',
    ...
    B: {
      ...
      waitlistSub:      'We\'re building Sawubona now. The more we know about your loved one upfront, the faster we can find the right match and get started.',
      familyFormHeading:'Find a companion for my loved one',
      familyFormSub:    'Tell us a little about your loved one so we can find the right culturally matched companion',
      elderNamePH:      'e.g. Kofi Mensah',
